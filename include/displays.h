...
//! @note These are our commands for where we write data to our display
// constexpr uint8_t SSD_1331_COL_ADDR = 0x15; //! @note Our col address
// constexpr uint8_t SSD_1331_ROW_ADDR = 0x75; //! @note Our row address
// constexpr uint8_t SSD_1331_INC_MODE = 0xA0; //! @note Increment mode

//! @note Fundamental Commands to display stuff to the SSD1331 Display
